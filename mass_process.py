...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="data/Massachusetts/png/val")
    parser.add_argument("--input-mask-dir", default="data/Massachusetts/png/val_labels")
    parser.add_argument("--output-img-dir", default="data/Massachusetts/png/val_images")
    parser.add_argument("--output-mask-dir", default="data/Massachusetts/png/val_masks")

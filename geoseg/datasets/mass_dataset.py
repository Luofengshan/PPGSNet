...
class MassBuildingDataset(Dataset):
    def __init__(self, data_root='data/whubuilding/train', mode='train', img_dir='image', mask_dir='label',
    ...
    def load_img_and_mask(self, index):
        ...
        mask = (1-np.array(mask) / 255).astype(np.uint8)

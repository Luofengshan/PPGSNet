...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="data/Aerial/train/images")
    parser.add_argument("--input-mask-dir", default="data/Aerial/train/gt")
    parser.add_argument("--output-img-dir", default="data/Aerial/train/train/train_images")
    parser.add_argument("--output-mask-dir", default="data/Aerial/train/train/masks")
